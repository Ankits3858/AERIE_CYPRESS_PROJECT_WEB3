...
function addCompareSnapshotCommand(screenshotOptions) {
  Cypress.Commands.add(
    ...
    function(subject, name, commandOptions) {
      ...
      return takeScreenshot(subject, name, screenshotOptions).then((screenshotAbsolutePath) => {
...
function prepareOptions(name, errorThreshold, screenshotOptions) {
  ...
  const options = {
    type: Cypress.env("visualRegression").type,
    screenshotName: name,
  ...
  } else if (Cypress.env("visualRegression").failSilently !== void 0) {
