...
describe("testing the portfolio management page with broken url,images,dropdowns and button", () => {


    it("Testcase 1===> testing of broken links on portfolio management page inside sandbox environment", () => {
        ...
        home.get_tools().click({ force: true })
        home.get_portfolio_management().click({ force: true })
    ...
    it("Testcase 2===> testing of broken links on portfolio management page inside production environment", () => {
    ...
    it("Testcase 3===> testing of broken images on portfolio management page inside sandbox environment", () => {
    ...
    it("Testcase 4===> testing of broken images on portfolio management page inside production environment", () => {
 ...
 it("Testcase 5===> testing of non executed buttons on portfolio management page inside sandbox environment", () => {
...
it("Testcase 6===> testing of non executed buttonss on portfolio management page inside production environment", () => {
...
it("Testcase 7===> testing of dropdowns and filters on portfolio management page inside sandbox environment", () => {
...
it("Testcase 8===> testing of dropdowns and filters on portfolio management page inside production environment", () => {
