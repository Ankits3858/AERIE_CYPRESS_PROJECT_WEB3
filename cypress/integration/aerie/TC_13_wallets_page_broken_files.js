...
describe("testing the wallet page with broken url,images,dropdowns and button", () => {
    ...
    it("Testcase 1===> testing of broken links on wallet page inside sandbox environment", () => {
    ...
    it("Testcase 2===> testing of broken links on wallet page inside production environment", () => {
    ...
    it("Testcase 3===> testing of broken images on wallet page inside sandbox environment", () => {
    ...
    it("Testcase 4===> testing of broken images on wallet page inside production environment", () => {
 ...
 it("Testcase 5===> testing of non executed buttons on wallet page inside sandbox environment", () => {
...
it("Testcase 6===> testing of non executed buttonss on wallet page inside production environment", () => {
...
it("Testcase 7===> testing of dropdowns and filters on wallet page inside sandbox environment", () => {
...
it("Testcase 8===> testing of dropdowns and filters on wallet page inside production environment", () => {
