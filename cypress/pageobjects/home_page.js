...
get_invoices()
{
    return cy.xpath("//a[normalize-space()='Invoices']") 
}
//a[normalize-space()='Members']
get_members()
{
    return cy.get(":nth-child(6) > .collapse > .nav > :nth-child(3) > .nav-link") 
}
get_wallets()
{
...
get_tools()
{
    return cy.xpath("//span[normalize-space()='Tools']")
}
get_portfolio_management()
{
    return cy.xpath("//a[normalize-space()='Portfolio Management']")
}
